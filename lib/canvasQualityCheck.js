...
export function checkImageQuality(imgElement) {
  ...
  // Luminance threshold: 0.08 (cho phép ảnh chụp trong chuồng nuôi tối, chỉ chặn ảnh đen hoàn toàn)
  ...
  // Blur threshold: 30 (chặn ảnh bị rung mạnh/mờ hoàn toàn, cho phép ảnh phone 4G chất lượng trung bình)
  if (blurVariance < 30) {
